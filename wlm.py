...
class hf_wlm(object):
    ...
    def get_pattern_data(self):
        # PARRAY = (ctypes.c_ulong * 2048)()
        array =(ctypes.c_ulong * 2048)()
        array[1] = 100
        self.dll.GetPatternData(ctypes.c_long(0), array)
        for i in range(10):
            print(i)
            print(array[i])

    def set_pattern_num(self):
        self.dll.SetPatternNum(ctypes.c_long(0),ctypes.c_long(1))

    def get_pattern(self):
        return float(self.dll.GetPattern(ctypes.c_long(2),ctypes.c_long(0)))

    def get_pattern_item_count(self):
        return self.dll.GetPatternItemCount(ctypes.c_long(0))

    def get_pattern_item_size(self):
        return self.dll.GetPatternItemSize(ctypes.c_long(0))

    def get_analysis(self):
        return self.dll.GetAnalysis(ctypes.c_long(2),ctypes.c_long(0))

    def get_analysis_item_count(self):
        return self.dll.GetAnalysisItemCount(ctypes.c_long(0))

    def get_analysis_item_size(self):
        return self.dll.GetAnalysisItemSize(ctypes.c_long(0))
